...
class Modelo extends Conexion {
 ...
 public function getDropDown($tabla,$name,$id,$where = ' '){
     ...
     $dropDown.= '<option value="'.$value['id_revista'].'">'.utf8_encode($value['nombre']).'</option>';
    ...
    public function getDropDown1($tabla,$name,$id,$where = ' '){
     ...
     $dropDown.= '<option value="'.$value['id_indice'].'">'.utf8_encode($value['titulo']).'</option>';
    ...
    public function getDropDown2($tabla,$name,$id,$where = ' '){
     ...
     $dropDown.= '<option value="'.$value['id_articulo'].'">'.utf8_encode($value['nombre']).'</option>';
    ...
    public function getDropDown3($tabla,$name,$id,$where = ' '){
     ...
     $dropDown.= '<option value="'.$value['id_status'].'">'.utf8_encode($value['status']).'</option>';
